...
describe Atm do
  ...
  it 'should be able to withdraw' do
    subject.withdraw(50, 1234, '04/17', :Active, account)
  ...
  it 'rejects withrawal if account is disabled' do
    ...
    expect(subject.withdraw(6, 1234, '04/17', :Disabled, account)).to eq expected_output
  end
  ...
  it 'rejects withdrawal if card is expired' do
    ...
    expect(subject.withdraw(6, 1234, '12/15', :Active, account)).to eq expected_output
  end
  ...
  it 'rejects withdrawal if account has insufficient funds' do
    ...
    expect(subject.withdraw(155, 1234, '04/17', :Active, account)).to eq expected_output
  end
  ...
  it 'will allow withdrawal if account has enough funds' do
    ...
    expect(subject.withdraw(50, 1234, '04/17', :Active, account)).to eq expected_output
  end
